...
final class UnitYAD: XCTestCase {
    ...
    func testDecryption() {
        ...
        guard let url = testBundle.url(forResource: "payload", withExtension: "enc") else {return}
        guard let decUrl = testBundle.url(forResource: "payload", withExtension: "dec") else {return}
